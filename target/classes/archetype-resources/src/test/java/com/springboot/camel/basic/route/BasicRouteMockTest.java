...
public class BasicRouteMockTest{
	...
	public void testMoveFileMock() throws InterruptedException {
		String message = "employeeId,rates${symbol_escape}n"+
							"EM001, 140.00${symbol_escape}n"+
							"EM016, 180.00${symbol_escape}n"+
							"EM018, 150.00${symbol_escape}n"+
							"EM031, 130.00${symbol_escape}n"+
							"EM034, 120.00${symbol_escape}n";
